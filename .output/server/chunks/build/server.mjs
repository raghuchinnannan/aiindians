import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, defineAsyncComponent, toRef, isRef, defineComponent, useSSRContext, provide, shallowReactive, h, Suspense, nextTick, Transition, shallowRef, onServerPrefetch, createElementBlock, unref, computed, withAsyncContext, mergeProps, createVNode, resolveDynamicComponent, resolveComponent, createApp, effectScope, reactive, onErrorCaptured, isReadonly, withCtx, createTextVNode, toDisplayString, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch$1, l as klona, m as defu, w as withBase, n as withLeadingSlash, o as joinURL, p as withoutTrailingSlash, q as defuFn, r as hasProtocol, t as parseURL, v as parseQuery, x as hash, y as createHooks, h as createError$1, z as parse, A as getRequestHeader, B as withQuery, C as isScriptProtocol, D as withTrailingSlash, E as destr, F as isEqual, G as setCookie, H as getCookie, I as deleteCookie, J as sanitizeStatusCode, K as isSamePath, L as toRouteMatcher, M as createRouter$1 } from '../runtime.mjs';
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderVNode, ssrRenderSlot, ssrInterpolate, ssrRenderSuspense, ssrRenderList } from 'vue/server-renderer';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./communities-2Bu_e2Nm.mjs').then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./contact-D0a-FpTh.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-C1wDppFM.mjs').then((m) => m.default || m)
  },
  {
    name: "leaderboard",
    path: "/leaderboard",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./leaderboard-DQ71Jgda.mjs').then((m) => m.default || m)
  },
  {
    name: "people",
    path: "/people",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./people-CYuEg3Rd.mjs').then((m) => m.default || m)
  }
];
...
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-DgGQrFt5.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-COVWAkdX.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-Cz4C4tCc.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-DzunH8yg.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-D7XMtd4u.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-COJ9hRVR.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-BK0pQm6n.mjs').then((r) => r["default"] || r.default || r));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-BCe7-UHp.mjs').then((r) => r["default"] || r.default || r));
const LazyProseA = defineAsyncComponent(() => import('./ProseA-3U-Dr5Fn.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-CWRckRpn.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-x5J-WzIK.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-DIq_bsFw.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-BI68yrw8.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-vX3o7w6m.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-CuKE8xon.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-pfjBRlkm.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-4INVp_2c.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-B-c1slYQ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-DCTl0dEO.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-CrmDqd6T.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-BUsCOTcG.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-Dfifxx7b.mjs').then((r) => r["default"] || r.default || r));
const LazyProseScript = defineAsyncComponent(() => import('./ProseScript-D0R07iM6.mjs').then((r) => r["default"] || r.default || r));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-xfSJWCZZ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-C2X-O0n_.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-BkVWSAMT.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-DR8RUMxI.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-DV5fj3gC.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-aBIaeSJt.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-C5l1adEE.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-IPLl5OV5.mjs').then((r) => r["default"] || r.default || r));
const LazyIcon = defineAsyncComponent(() => Promise.resolve().then(function() {
  return Icon;
}).then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-CVQdJbgh.mjs').then((r) => r["default"] || r.default || r));
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-e8d572f6"]]);
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-Du0zcfwe.mjs').then((m) => m.useContentDatabase());
...
const _sfc_main$2 = {
  ...
  setup() {
    ...
    const projectCount = computed(() => {
      var _a;
      return (_a = projectsData.value) == null ? void 0 : _a.length;
    });
    const peopleCount = computed(() => {
      var _a;
      return (_a = peopleData.value) == null ? void 0 : _a.length;
    });
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_Head, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<title${_scopeId}>AI Indians · Celebrating India’s AI Builders</title>`);
      } else {
        return [
          createVNode("title", null, "AI Indians · Celebrating India’s AI Builders")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`<div class="hero"><div class="logo">`);
  _push(ssrRenderComponent(_component_Icon, { name: "i-ph-brain-thin" }, null, _parent));
  _push(` AI Indians</div> A resource to celebrate and stay updated with the latest AI projects &amp; people in India.<br>`);
  if ($setup.projectCount > 0 || $setup.peopleCount > 0) {
    _push(`<div>Featuring <span class="text-green-300">${ssrInterpolate($setup.projectCount)}</span> projects and <span class="text-green-300">${ssrInterpolate($setup.peopleCount)}</span> people.</div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<div>`);
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/contact" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Submit a Project →`);
      } else {
        return [
          createTextVNode("Submit a Project →")
        ];
      }
    }),
    _: 1
  ...
  _push(`</div></div><nav><!--[-->`);
  ssrRenderList($setup.menus, (menu) => {
    _push(ssrRenderComponent(_component_NuxtLink, {
      key: menu.slug,
      to: menu.slug,
      class: ["link", { current: _ctx.$route.path === menu.slug }]
    }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`${ssrInterpolate(menu.icon)} ${ssrInterpolate(menu.name)}`);
        } else {
          return [
            createTextVNode(toDisplayString(menu.icon) + " " + toDisplayString(menu.name), 1)
          ];
        }
      }),
      _: 2
  ...
  _push(`<!--]--></nav>`);
  if ($setup.pageTitle) {
    _push(`<h1 class="main-title">${ssrInterpolate($setup.pageTitle)}</h1>`);
  } else {
    _push(`<!---->`);
  }
  _push(ssrRenderComponent(_component_NuxtPage, null, null, _parent));
  _push(`<footer class="colophon"><div class="flex mb-4"><div class="w-1/2 nav"><!--[-->`);
  ssrRenderList($setup.menus, (menu) => {
    _push(ssrRenderComponent(_component_NuxtLink, {
      key: menu.slug,
      to: menu.slug,
  ...
  _push(`<!--]--></div><div class="w-1/2"><div class="logo">`);
  _push(ssrRenderComponent(_component_Icon, { name: "i-ph-brain-thin" }, null, _parent));
  _push(` AI Indians</div><div>Source on <a href="https://github.com/namanyayg/aiindians" target="_blank">Github</a></div><div>By <a href="https://x.com/NamanyayG">Namanyay Goel</a> ⚡</div></div></div></footer></div>`);
}
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CPQWqNC3.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-C9l-sFYS.mjs').then((r) => r.default || r));
...
export { useNuxtApp as A, _export_sfc as _, __nuxt_component_0 as a, __nuxt_component_0$1 as b, useAsyncData as c, useRoute as d, entry$1 as default, useRuntimeConfig as e, encodeQueryParams as f, addPrerenderPath as g, useContentPreview as h, useState as i, jsonStringify as j, useContentDisabled as k, useAppConfig as l, get as m, assertArray as n, ensureArray as o, omit as p, queryContent as q, resolveIconName as r, shouldUseClientDB as s, sortList as t, useHead as u, apply as v, withContentBase as w, withoutKeys as x, withKeys as y, createQuery as z };
