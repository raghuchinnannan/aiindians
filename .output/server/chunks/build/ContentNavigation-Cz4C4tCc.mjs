import { i as useState, k as useContentDisabled, c as useAsyncData, e as useRuntimeConfig, q as queryContent, w as withContentBase, f as encodeQueryParams, g as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify, h as useContentPreview, a as __nuxt_component_0 } from './server.mjs';
import { x as hash } from '../runtime.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-Du0zcfwe.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-Cz4C4tCc.mjs.map
